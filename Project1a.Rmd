...
MVar = NULL
set.seed(33)
for (i in 1:1000) MVar = c(MVar, var(rexp(40,0.2)))
```
...
abline(v = (1/0.2)^2, col = "blue", lwd = 4)
abline(v = mean(MVar), col = "purple", lwd = 4)
legend("topright", lty = 1, lwd = 4, col = c("blue", "purple"), legend = c("Theoretical", "Sample"))
text((1/.04)+5, 200, labels = (1/.2)^2, col = "blue", lwd = 2)
text(mean(MVar)-5, 200, labels = round(mean(MVar),3), col = "purple", lwd = 2)
```
